            ...
            <div className='flex w-full text-white items-center justify-between px-2 py-4 md:px-8 md:py-3'>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <div className='flex md:hidden'>
                        ...
                        <div>
                            <button className={`hover:scale-105 transition-all duration-200 px-4 py-1 rounded-lg text-black bg-white ${scrolled ? 'block' : 'hidden'} `}><a href='https://tally.so/r/waD9X9'>Join</a></button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex justify-between w-full px-2 py-4">
                ...
                <div className='flex items-center gap-4'>
                    <div className={`border-2 border-red-900`}>
                        <button className={`hover:scale-105 transition-all duration-200 px-4 py-1 rounded-xl bg-black text-white `}><a href='https://tally.so/r/waD9X9'>Join</a></button>
                    </div>
                    <button className='hover:scale-105 transition-all duration-200 text-xl' onClick={closeMenu}>
                        <RxCross1 />
                    </button>
                </div>
            </div>
