...
//       >
//         <div className="flex items-center justify-center pt-40 text-center font-sf text-[30px] font-semibold text-black">
//           Raise the Bar,{" "}
//           <span>
//             <img
...
//         scrollTrigger: {
//           trigger: containerRef.current,
//           start: idx === 0 ? "top+=200%" : "center center",
//           end: "+=3000",
//           scrub: true,
//         },
//       });
...
//     <div
//       ref={containerRef}
//       className="relative flex border-4 border-red-400 flex-col mx-auto justify-center items-center w-full h-screen overflow-hidden"
//     >
//       {imageSections.map((section, idx) => (
//         <div
//           key={idx}
//           ref={imageContainerRefs[idx]}
//           className={`absolute inset-0 border-4 border-yellow-400 flex flex-col items-center justify-start ${section.bgClass} whitespace-nowrap`}
//         >
//           <div
//             ref={headerRefs[idx]}
...
//           <div
//             ref={imageRefs[idx]}
//             className="flex border-4 border-blue-400 h-[1200px] items-center gap-[60px]"
//           >
...
const RiseTheBarMobile = () => {
  ...
  useEffect(() => {
    ...
    imageContainerRefs.forEach((imageContainerRef, idx) => {
      ...
      gsap.to(headerRefs[idx].current, {
        ...
        scrollTrigger: {
          trigger: imageContainerRef.current,
          start: "top+=300px bottom", // Adjust this to delay the header fade-out
          scrub: true,
        },
      });
  ...
  return (
    ...
    >
      {imageSections.map(
        (section, idx) => (
          console.log("section", section, idx),
          (
            <div
              key={idx}
              ref={imageContainerRefs[idx]}
